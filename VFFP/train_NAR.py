...
if __name__ == '__main__':
    ...
    loss_dict, other_dict = resume_training({'VPTR_Enc': VPTR_Enc, 'VPTR_Dec': VPTR_Dec}, {}, resume_AE_ckpt, loss_name_list, map_location=torch.device('cpu'))

    if resume_ckpt is not None:
        loss_dict, _ = resume_training({'VPTR_Transformer': VPTR_Transformer}, 
                                                {'optimizer_T':optimizer_T}, resume_ckpt, loss_name_list, map_location=torch.device('cpu'))
